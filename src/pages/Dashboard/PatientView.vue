        ...
        <md-card-content>
          ...
          >
            ...
            <md-table-row slot="md-table-row" slot-scope="{ item }">
              <md-table-cell md-label="Last Name" md-sort-by="name">{{item.lastName}}</md-table-cell>
              <md-table-cell md-label="First Name" md-sort-by="email">{{item.firstName}}</md-table-cell>
              <md-table-cell md-label="Street">{{ item.street }}</md-table-cell>
      ...
      return (
          {
            ...
            footerTable: ["Last Name", "First Name", "Street", "City", "State", "Status", "Actions"],
            searchQuery: "",

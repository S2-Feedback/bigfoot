    ...
    <div class="dflex-center-col">
      <div class="md-layout dflex-center-row">
        <div class="md-layout-item md-medium-size-30 md-xsmall-size-100 md-size-25">
          <stats-card header-color="rose" style="box-shadow: black 0px 0px 16px -7px;">
        ...
        <div class="md-layout-item md-medium-size-30 md-xsmall-size-100 md-size-25">
          <stats-card header-color="primary" style="box-shadow: black 0px 0px 16px -7px;">
            <template slot="header">
              <div class="card-icon">
        ...
        <div class="md-layout-item md-medium-size-30 md-xsmall-size-100 md-size-25">
          <stats-card header-color="danger" style="box-shadow: black 0px 0px 16px -7px;">
            <template slot="header">
              <div class="card-icon">
      ...
      <md-card style="box-shadow: black 0px 0px 16px -7px; margin-top:100px; width:75%;">
        <md-card-header
...
export default {
  ...
  methods: {
    handleNewPatientClick() {
      this.$router.push({ name: "Add Patient", params: {returnTo: 'Care Manager Portal'} });
    },

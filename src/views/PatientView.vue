<template>
  <div class="dflex-center-col">
    <div class="md-layout dflex-center-row">
      <div
        class="md-layout-item md-medium-size-33 md-xsmall-size-33 dflex-center-row"
      >
        <md-card
          style="box-shadow: black 0px 0px 16px -7px; margin-top:100px; width:95%;"
        >
          <md-card-header
    ...
    <div class="md-layout dflex-center-row">
      <div
        class="md-layout-item md-medium-size-100 md-xsmall-size-100 dflex-center-row"
      >
        <md-card
          style="box-shadow: black 0px 0px 16px -7px; margin-top:100px; width:95%;"
        >
          ...
          >
            ...
            >
              ...
              <md-table-row slot="md-table-row" slot-scope="{ item }">
                <md-table-cell
                  md-label="Date Of Visit"
                  md-sort-by="dateOfVisit"
                  >{{ item.patient_lastName }}</md-table-cell
                >
                <md-table-cell
                  md-label="Assessement Status"
                  md-sort-by="firstName"
                  >{{ item.patient_firstName }}</md-table-cell
                >
